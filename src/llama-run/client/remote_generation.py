...
from llama-run.client.inference_session import InferenceSession
from llama-run.client.remote_sequential import RemoteSequential
from llama-run.utils.misc import DUMMY, docstring_from
        ...
        with context_manager as session:
            ...
            if n_prev_tokens > 0:
                if kwargs.get("num_beams", 1) > 1:
                    logger.warning(
                        "Beam search will not work properly in the resumed llama-run.InferenceSession "
