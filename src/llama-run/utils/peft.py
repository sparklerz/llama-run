...
from llama-run.utils.disk_cache import allow_cache_reads, allow_cache_writes, free_disk_space_for
...
def load_peft(
    ...
    *,
    ...
    # TODO: Check is it possible to add safetensors loading inside llama-run/server/from_pretrained.py and reuse it here
