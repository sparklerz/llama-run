...
from llama-run.data_structures import Handle, InferenceMetadata
from llama-run.server.backend import TransformerBackend
from llama-run.server.task_pool import PrioritizedTaskPool
from llama-run.server.task_prioritizer import TaskPrioritizerBase
from llama-run.utils.convert_block import QuantType
from llama-run.utils.misc import DUMMY, is_dummy
from llama-run.utils.packaging import unpack_args_kwargs
...
async def run_rpc_forward(
    *flat_tensors: torch.Tensor,
    ...
    for backend, prompt in zip(requested_backends, prompts):
        ...
        assert isinstance(backend.inference_pool, PrioritizedTaskPool), "llama-run support only prioritized pools"
