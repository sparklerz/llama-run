...
from llama-run.data_structures import InferenceMetadata
from llama-run.server.memory_cache import MemoryCache
from llama-run.server.task_pool import PrioritizedTaskPool
from llama-run.utils.misc import get_size_in_bytes, is_dummy
...
class TransformerBackend(ModuleBackend):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        import llama-run.utils.peft as _peft_module
